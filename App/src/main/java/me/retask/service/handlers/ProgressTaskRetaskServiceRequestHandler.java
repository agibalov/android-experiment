...
public class ProgressTaskRetaskServiceRequestHandler extends RetaskServiceRequestHandler {
    @Override
    public void process(Intent input, ContentResolver contentResolver, String apiRootUrl, RestTemplate restTemplate) {
        ...
        ApiCall<TaskDto> progressTaskApiCall = new ProgressTaskApiCall(sessionToken, taskRemoteId);
        ServiceResultDto<TaskDto> progressTaskApiCallResult = progressTaskApiCall.performApiCall(apiRootUrl, restTemplate);
